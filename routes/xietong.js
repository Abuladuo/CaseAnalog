...
//协同平台 => 待办案件
router.get('/xietong/daiban/:username', async (ctx,_next)=>{
...
//协同平台 => 挂账案件
router.get('/xietong/guazhang/:username', async (ctx,_next)=>{
...
//协同平台 => 经办案件
router.get('/xietong/jingban/:username', async (ctx,_next)=>{

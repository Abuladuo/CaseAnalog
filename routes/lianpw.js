...
//受理平台=>立案
router.get('/shouli/lian/:username/:password', async (ctx,_next)=>{
...
var getdata = function(username,password){
     ...
     var url3 = 'http://10.19.179.6/eUrbanMIS/home/bizbase/tasklist/gethumantasklistdata?taskListID=29&currentPage=1&numPerPage=20&sortFieldID=-1&sortType=&onlyDataFlag=false&_=1574930745957'
...
//受理平台 => 登记
router.get('/shouli/dengji/:username/:password', async (ctx,_next)=>{
...
//受理平台 => 经办
router.get('/shouli/jingban/:username/:password', async (ctx,_next)=>{
...
//受理平台 => 核查
router.get('/shouli/hecha/:username/:password', async (ctx,_next)=>{
...
//受理平台 => 自行处置
router.get('/shouli/zixing/:username/:password', async (ctx,_next)=>{
...
//受理平台 => 视频案件
router.get('/shouli/shipin/:username/:password', async (ctx,_next)=>{
